...
1. Der Kunde kann seine Daten während der Vertragslaufzeit jederzeit selbst exportieren. Dafür stellt der Anbieter kostenlos offene Schnittstellen und deren Dokumentation bereit, insbesondere Git, SSH, SFTP, Datenbankzugänge und die API.
2. Exportierbare Daten sind die Daten und digitalen Güter, die der Kunde eingebracht oder bei der Nutzung erzeugt hat, insbesondere Quelltext, Dateien, Datenbanken, Umgebungsvariablen und Einstellungen der Umgebungen. Ausgenommen sind Daten, die ausschließlich den Betrieb des Anbieters betreffen, etwa interne Protokolle und Sicherheitsdaten, sowie Daten, die Geschäftsgeheimnisse des Anbieters oder Rechte Dritter berühren.
3. Der Kunde kann in Textform verlangen, zu einem anderen Anbieter oder in eine eigene Infrastruktur zu wechseln oder alle exportierbaren Daten löschen zu lassen (Verordnung (EU) 2023/2854, Data Act). Mit Zugang des Verlangens beginnt ein Übergangszeitraum von 30 Tagen, in dem der Dienst unverändert weiterläuft und der Anbieter den Wechsel in angemessenem Umfang unterstützt. Ist der Wechsel in dieser Zeit technisch nicht möglich, teilt der Anbieter dies innerhalb von 14 Arbeitstagen mit Begründung mit und nennt einen alternativen Zeitraum von höchstens sieben Monaten. Das Kündigungsrecht nach § 8 bleibt unberührt.
4. Nach dem Übergangszeitraum kann der Kunde seine Daten noch mindestens 30 Tage abrufen. Danach löscht der Anbieter die exportierbaren Daten. Der Vertrag endet mit dem erfolgreichen Abschluss des Wechsels, spätestens mit Ablauf des Abrufzeitraums.
5. Löscht der Kunde eine App, eine Umgebung oder sein Konto selbst im Dashboard, gilt dies als Weisung zur sofortigen Löschung der betroffenen Daten. Die Fristen aus Absatz 3 und 4 gelten dann nicht.
6. Für den Wechsel und den Datenexport erhebt der Anbieter keine Wechselentgelte. Die Vergütung nach § 5 für die Nutzung des Dienstes während des Übergangs- und Abrufzeitraums bleibt unberührt.
